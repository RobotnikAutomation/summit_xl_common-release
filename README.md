## summit_xl_common (kinetic) - 1.1.3-2

The packages in the `summit_xl_common` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release summit_xl_common --track kinetic --ros-distro kinetic` on `Thu, 17 May 2018 06:56:48 -0000`
...
## summit_xl_common (kinetic) - 1.1.2-0

The packages in the `summit_xl_common` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic summit_xl_common --edit` on `Thu, 01 Sep 2016 07:15:30 -0000`
...
## summit_xl_common (indigo) - 1.0.10-0

The packages in the `summit_xl_common` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo summit_xl_common` on `Thu, 01 Sep 2016 07:05:45 -0000`
...
## summit_xl_common (kinetic) - 1.1.1-0

The packages in the `summit_xl_common` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic summit_xl_common --edit` on `Wed, 24 Aug 2016 05:50:38 -0000`
...
## summit_xl_common (indigo) - 1.0.9-0

The packages in the `summit_xl_common` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo summit_xl_common` on `Wed, 24 Aug 2016 05:33:50 -0000`
